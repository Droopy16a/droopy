...
function Box({ title, desc, color = 'indigo', icon = "faCoffee", link = null }) {
  ...
  return (
    <div className="relative group">
      ...
      <div className={`border-2 bg-gradient-to-br from-gray-900 ${c.borderLight} rounded-lg p-4 sm:p-6 relative z-10 h-full ${c.borderHover} transition-all duration-300`}>
        <div className="flex flex-col h-full">
          ...
          { link ? <a href={link} className={`mt-auto ${c.link} inline-flex items-center text-sm sm:text-base`}>
            Learn more
